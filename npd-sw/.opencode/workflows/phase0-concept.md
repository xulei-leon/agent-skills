...
- Output: `docs/0-Concept/Market_Research.md`
- Include: TAM/SAM/SOM, competitor analysis, SWOT, user personas, business model

### Step 2: User Research
- Use the `market-analysis` skill
- Output: `docs/0-Concept/User_Research.md`
...
- Output: `docs/0-Concept/Charter.md`
...
- Bump `docs/0-Concept/Charter.md`, `docs/0-Concept/Market_Research.md`, `docs/0-Concept/User_Research.md` if modified
